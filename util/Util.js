...
let maxPlaylistSize = (config ? config.MAX_PLAYLIST_SIZE : parseInt(process.env.MAX_PLAYLIST_SIZE)) || 10;
...
exports.MAX_PLAYLIST_SIZE = Math.sign(maxPlaylistSize) != -1 ? maxPlaylistSize : Infinity;
